...
PyKale is one of only four libraries officially listed under "Multimodal" in the [PyTorch Landscape](https://landscape.pytorch.org/), alongside MMF from Meta, NeMo from NVIDIA, and USB from Microsoft. More distinctively, PyKale is the only library in this category positioned for training rather than modeling, reflecting our focus on reusable workflows, evaluation, adaptation, and deployable multimodal AI systems.
