...
## 4. *Sample* output of 10 runs for reference (with PyTorch 2.0+ and 120 epochs by maximum)

### Summary of MNIST → USPS results

| Seed | Source Target Acc | DANN Target Acc | CDAN Target Acc |
|------|-------------------|------------------|------------------|
| 2025 | 0.5183            | 0.8044           | 0.8338           |
| 2035 | 0.5246            | 0.7921           | 0.7676           |
| 2045 | 0.4000            | 0.7993           | 0.7804           |
| 2055 | 0.5144            | 0.8393           | 0.8039           |
| 2065 | 0.5175            | 0.7953           | 0.8035           |
| 2075 | 0.5300            | 0.8626           | 0.8371           |
| 2085 | 0.4498            | 0.8191           | 0.7978           |
| 2095 | 0.5202            | 0.7472           | 0.7727           |
| 2105 | 0.4268            | 0.7035           | 0.7966           |
| 2115 | 0.5548            | 0.8765           | 0.7431           |
| **Mean ± Std** | **0.495 ± 0.046** | **0.804 ± 0.053** | **0.794 ± 0.035** |
...
| Seed | Test Source Acc | Test Target Acc | Domain Acc |
|------|-----------------|-----------------|------------|
| 2025 | 0.9907          | 0.8044          | 0.3830     |
| 2035 | 0.9922          | 0.7921          | 0.0947     |
| 2045 | 0.9926          | 0.7993          | 0.5948     |
| 2055 | 0.9912          | 0.8393          | 0.4240     |
| 2065 | 0.9922          | 0.7953          | 0.4091     |
| 2075 | 0.9927          | 0.8626          | 0.4876     |
| 2085 | 0.9929          | 0.8191          | 0.4537     |
| 2095 | 0.9907          | 0.7472          | 0.6810     |
| 2105 | 0.9909          | 0.7035          | 0.4500     |
| 2115 | 0.9917          | 0.8765          | 0.2530     |

### Results using legacy implementation on PyTorch 1.x (for reference only)
